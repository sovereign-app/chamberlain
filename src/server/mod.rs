...
create_config_structs!(
    ...
    (rpc_auth_disable: bool, "Disable RPC authentication"),
    (rpc_auth_jwks_url: Url, "RPC OAuth2 JWKS URL"),
    (rpc_auth_sub: String, "RPC OAuth2 subject"),
...
impl Default for Config {
    fn default() -> Self {
        Self {
            ...
            rpc_port: 3339,
            rpc_auth_disable: false,
            rpc_auth_jwks_url: "http://localhost:3339/jwks".parse().unwrap(),
            rpc_auth_sub: "chamberlain".to_string(),
